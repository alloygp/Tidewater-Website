// Rental — Maryland County Regulatory Map (interactive county selector)
function RentalCounty() {
  const counties = [
  ...
  const [active, setActive] = React.useState('montgomery');
...
window.RentalCounty = RentalCounty;
